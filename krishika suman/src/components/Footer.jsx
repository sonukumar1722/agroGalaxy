          ...
          <div className="md:flex md:justify-between">
            ...
            <div className="grid grid-cols-1 gap-8 sm:gap-4 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <div>
                ...
                <div className="my-8">
                  <input
                    className=" h-20 w-[345px] rounded-md border-none outline-none text-black p-6 text-2xl font-medium"
                    required
                    type="email"
                ...
                <button className="border p-5 px-10 rounded-bl-3xl rounded-br-3xl rounded-tr-3xl bg-[#009444] border-[#009444] font-bold uppercase">
                  Subscribe Now
                </button>
              </div>
            </div>
